...
-- Admin users
('admin', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin@ecommerce.com', 'System Administrator', '0901234567', '123 ABC Street, District 1, HCMC', 'admin', true, true, NOW(), NOW()),
('admin2', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin2@ecommerce.com', 'Administrator 2', '0901234568', '456 DEF Street, District 2, HCMC', 'admin', true, true, NOW(), NOW()),

-- Regular users
('user001', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'john.doe@gmail.com', 'John Doe', '0912345678', '789 GHI Street, District 3, HCMC', 'user', true, true, NOW(), NOW()),
('user002', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'jane.smith@gmail.com', 'Jane Smith', '0923456789', '321 JKL Street, District 4, HCMC', 'user', true, true, NOW(), NOW()),
('user003', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'michael.johnson@gmail.com', 'Michael Johnson', '0934567890', '654 MNO Street, District 5, HCMC', 'user', true, true, NOW(), NOW()),
('user004', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'sarah.wilson@gmail.com', 'Sarah Wilson', '0945678901', '987 PQR Street, District 6, HCMC', 'user', true, true, NOW(), NOW()),
('user005', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'david.brown@gmail.com', 'David Brown', '0956789012', '147 STU Street, District 7, HCMC', 'user', true, true, NOW(), NOW()),
('user006', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'emma.davis@gmail.com', 'Emma Davis', '0967890123', '258 VWX Street, District 8, HCMC', 'user', true, true, NOW(), NOW()),
('user007', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'robert.miller@gmail.com', 'Robert Miller', '0978901234', '369 YZ Street, District 9, HCMC', 'user', true, true, NOW(), NOW()),
('user008', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'lisa.garcia@gmail.com', 'Lisa Garcia', '0989012345', '741 ABC1 Street, District 10, HCMC', 'user', true, true, NOW(), NOW()),
('user009', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'james.martinez@gmail.com', 'James Martinez', '0990123456', '852 DEF1 Street, District 11, HCMC', 'user', true, true, NOW(), NOW()),
('user010', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'maria.rodriguez@gmail.com', 'Maria Rodriguez', '0901234560', '963 GHI1 Street, District 12, HCMC', 'user', true, true, NOW(), NOW());
...
-- =============================================
INSERT INTO products (name, description, import_price, selling_price, stock_quantity, category_id, image_url, is_featured, created_at, updated_at) VALUES
-- Smartphones
('iPhone 15 Pro Max 256GB', 'iPhone 15 Pro Max with A17 Pro chip, 48MP camera, 6.7 inch display', 25000000.00, 31990000.00, 50, 7, '/images/iphone-15-pro-max.jpg', true, NOW(), NOW()),
('Samsung Galaxy S24 Ultra', 'Galaxy S24 Ultra with S Pen, 200MP camera, Dynamic AMOLED 6.8 inch display', 22000000.00, 29990000.00, 45, 7, '/images/samsung-s24-ultra.jpg', true, NOW(), NOW()),
('Xiaomi 14 Ultra', 'Xiaomi 14 Ultra with Leica camera, Snapdragon 8 Gen 3 chip', 18000000.00, 24990000.00, 60, 7, '/images/xiaomi-14-ultra.jpg', false, NOW(), NOW()),
('OPPO Find X7 Pro', 'OPPO Find X7 Pro with Hasselblad camera, Dimensity 9300 chip', 16000000.00, 21990000.00, 40, 7, '/images/oppo-find-x7-pro.jpg', false, NOW(), NOW()),

-- Headphones
('Apple AirPods Pro Gen 2', 'Apple wireless earbuds with active noise cancellation', 4500000.00, 6290000.00, 80, 8, '/images/airpods-pro-gen2.jpg', true, NOW(), NOW()),
('Sony WH-1000XM5', 'Sony over-ear headphones with industry-leading noise cancellation', 6000000.00, 8990000.00, 30, 8, '/images/sony-wh1000xm5.jpg', true, NOW(), NOW()),
('JBL Tune 760NC', 'JBL over-ear headphones with noise cancellation', 1500000.00, 2490000.00, 70, 8, '/images/jbl-tune-760nc.jpg', false, NOW(), NOW()),

-- Gaming Laptops
('ASUS ROG Strix G15', 'ASUS gaming laptop with RTX 4060, AMD Ryzen 7', 18000000.00, 24990000.00, 25, 10, '/images/asus-rog-strix-g15.jpg', true, NOW(), NOW()),
('MSI Gaming GF63', 'MSI gaming laptop with GTX 1650, Intel Core i5', 12000000.00, 16990000.00, 30, 10, '/images/msi-gaming-gf63.jpg', false, NOW(), NOW()),
('Acer Nitro 5', 'Acer gaming laptop with RTX 3050, AMD Ryzen 5', 14000000.00, 18990000.00, 35, 10, '/images/acer-nitro-5.jpg', false, NOW(), NOW()),

-- Office Laptops
('MacBook Air M3 13 inch', 'MacBook Air with M3 chip, 8GB RAM, 256GB SSD', 24000000.00, 28990000.00, 40, 11, '/images/macbook-air-m3.jpg', true, NOW(), NOW()),
('Dell XPS 13', 'Dell XPS 13 with Intel Core i7, 16GB RAM, 512GB SSD', 28000000.00, 35990000.00, 20, 11, '/images/dell-xps-13.jpg', true, NOW(), NOW()),
('HP Pavilion 15', 'HP Pavilion 15 with Intel Core i5, 8GB RAM, 256GB SSD', 13000000.00, 17990000.00, 50, 11, '/images/hp-pavilion-15.jpg', false, NOW(), NOW()),

-- Men Clothing
('Men Oxford Shirt', 'High quality men Oxford shirt, white color', 150000.00, 299000.00, 100, 13, '/images/men-oxford-shirt.jpg', false, NOW(), NOW()),
('Men Polo T-Shirt', 'Men polo t-shirt 100% cotton, multiple colors', 120000.00, 249000.00, 150, 13, '/images/men-polo-tshirt.jpg', false, NOW(), NOW()),
('Men Bomber Jacket', 'Men bomber jacket with street style design', 200000.00, 399000.00, 80, 13, '/images/men-bomber-jacket.jpg', false, NOW(), NOW()),

-- Men Shoes
('Nike Air Max Sneakers', 'Nike Air Max sports shoes for men', 1800000.00, 2990000.00, 60, 15, '/images/nike-air-max-men.jpg', true, NOW(), NOW()),
('Men Oxford Leather Shoes', 'Black Oxford leather shoes for men, suitable for office', 800000.00, 1490000.00, 40, 15, '/images/men-oxford-leather.jpg', false, NOW(), NOW()),
('Adidas Ultraboost Sneakers', 'Adidas Ultraboost 22 sneakers', 2200000.00, 3490000.00, 35, 15, '/images/adidas-ultraboost.jpg', true, NOW(), NOW()),

-- Home appliances
('Panasonic Rice Cooker 1.8L', 'Panasonic electric rice cooker 1.8L for 4-6 people', 800000.00, 1290000.00, 100, 4, '/images/panasonic-rice-cooker.jpg', false, NOW(), NOW()),
('Philips Blender', 'Philips blender 2L, 600W power', 1200000.00, 1890000.00, 70, 4, '/images/philips-blender.jpg', false, NOW(), NOW()),
('Non-stick Pan Set 3pcs', 'Set of 3 non-stick pans in different sizes', 600000.00, 999000.00, 90, 4, '/images/nonstick-pan-set.jpg', false, NOW(), NOW());
...
-- Thống kê năm 2024
(2024, 1, 125000000.00, 18500000.00, 45, 1, DATE('2024-02-01')),
(2024, 2, 98000000.00, 15200000.00, 38, 2, DATE('2024-03-01')),
(2024, 3, 156000000.00, 22800000.00, 52, 1, DATE('2024-04-01')),
(2024, 4, 187000000.00, 28900000.00, 61, 11, DATE('2024-05-01')),
(2024, 5, 145000000.00, 21200000.00, 48, 8, DATE('2024-06-01')),
(2024, 6, 203000000.00, 32500000.00, 67, 1, DATE('2024-07-01')),
(2024, 7, 178000000.00, 26700000.00, 56, 2, DATE('2024-08-01')),
(2024, 8, 165000000.00, 24100000.00, 53, 11, DATE('2024-09-01')),
(2024, 9, 192000000.00, 29800000.00, 63, 1, DATE('2024-10-01')),
(2024, 10, 234000000.00, 38200000.00, 78, 1, DATE('2024-11-01')),
(2024, 11, 267000000.00, 42800000.00, 89, 11, DATE('2024-12-01')),
(2024, 12, 298000000.00, 48500000.00, 95, 1, DATE('2025-01-01'));
