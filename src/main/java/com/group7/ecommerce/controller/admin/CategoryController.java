...
public class CategoryController {
	...
	public String saveCategory(@Valid @ModelAttribute("categoryDto") CategoryDto categoryDto,
		...
		redirectAttributes.addFlashAttribute("successMessageKey", "admin.categories.messages.create_success");
	...
	public String updateCategory(@PathVariable Long id,
		...
		redirectAttributes.addFlashAttribute("successMessageKey", "admin.categories.messages.update_success");
		return "redirect:/admin/categories";
	}
	...
	public String deleteCategory(@PathVariable Long id, RedirectAttributes redirectAttributes) {
		try {
			...
			redirectAttributes.addFlashAttribute("successMessageKey", "admin.categories.messages.delete_success");
		} catch (Exception e) {
			logger.error("Error deleting category with id {}: {}", id, e.getMessage());
			redirectAttributes.addFlashAttribute("errorMessageKey", "admin.categories.messages.delete_error");
		}
		return "redirect:/admin/categories";
	}
}
