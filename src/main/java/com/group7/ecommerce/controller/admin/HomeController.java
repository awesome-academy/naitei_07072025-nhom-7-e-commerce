...
public class HomeController {
    ...
    public String processLogin(@Valid @ModelAttribute("loginDto") LoginDto loginDto,
        ...
        try {
            ...
            session.setAttribute("tokenType", jwtResponse.getType());
            session.setAttribute("userEmail", jwtResponse.getEmail());
            session.setAttribute("username", jwtResponse.getUsername());
            session.setAttribute("userFullName", jwtResponse.getFullName());
