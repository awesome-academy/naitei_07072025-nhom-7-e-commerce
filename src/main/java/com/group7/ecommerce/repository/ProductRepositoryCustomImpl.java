...
public class ProductRepositoryCustomImpl implements ProductRepositoryCustom {
    ...
    /**
     * Helper generic để thêm các predicate cho khoảng min/max, áp dụng cho mọi kiểu Comparable
     * (số, BigDecimal, LocalDateTime, ...).
     */
    private <T extends Comparable<? super T>> void addRangePredicates(
    ...
    private List<Predicate> buildPredicates(CriteriaBuilder cb, Root<Product> productRoot, 
        ...
        addRangePredicates(predicates, cb, productRoot.get("sellingPrice"),
                filterDto.minSellingPrice(), filterDto.maxSellingPrice());
        
        // Lọc theo khoảng giá nhập
        addRangePredicates(predicates, cb, productRoot.get("importPrice"),
                filterDto.minImportPrice(), filterDto.maxImportPrice());
        
        // Lọc theo số lượng tồn kho
        addRangePredicates(predicates, cb, productRoot.get("stockQuantity"),
        ...
        addRangePredicates(predicates, cb, productRoot.get("createdAt"),
                filterDto.createdAfter(), filterDto.createdBefore());
        
        // Lọc theo thời gian cập nhật
        addRangePredicates(predicates, cb, productRoot.get("updatedAt"),
                filterDto.updatedAfter(), filterDto.updatedBefore());
